    ...
    <div className="bg-surface-container-lowest dark:bg-background text-on-surface antialiased min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="z-10 flex flex-col items-center text-center mt-[-10%]">
          ...
          <h1 className="font-display-lg text-[40px] md:text-display-lg text-on-primary mb-6 leading-tight font-bold">Start Your Journey</h1>
          <p className="font-body-lg text-body-lg text-primary-container max-w-md mx-auto opacity-90">
            Join the modern student hub. Master your classes, sync notes, and boost grades with our integrated study tools.
          </p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 py-12 sm:px-12 lg:px-24 bg-surface-container-lowest dark:bg-surface-container-lowest relative">
        ...
        <div className="w-full max-w-[420px] mx-auto">
          {/* Header */}
          <div className="mb-8">
            <h2 className="font-headline-lg text-headline-lg text-on-surface mb-2 tracking-tight">Create your account</h2>
            <p className="font-body-md text-body-md text-on-surface-variant">Sign up today and get access to all features free.</p>
          </div>
          ...
          {successMsg && (
            <div className="mb-4 p-3 bg-secondary-container/20 text-secondary rounded-xl text-body-md flex items-start gap-xs">
              <span className="material-symbols-outlined text-[20px] text-secondary flex-shrink-0">check_circle</span>
          ...
          <div className="flex items-center my-6">
            ...
            <span className="px-4 font-label-md text-label-md text-on-surface-variant uppercase tracking-wider">Or credentials</span>
            <div className="flex-grow h-px bg-outline-variant/40"></div>
          </div>
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            <div>
              <label className="block font-title-md text-title-md text-on-surface mb-1.5" htmlFor="fullName">Full Name</label>
            ...
            <div>
              <label className="block font-title-md text-title-md text-on-surface mb-1.5" htmlFor="password">Password</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
          ...
          <p className="mt-8 text-center font-body-md text-body-md text-on-surface-variant">
            ...
            <Link href="/login" className="font-title-md text-title-md text-primary hover:underline hover:text-primary-container transition-colors ml-1">
              Log In
            </Link>
          </p>
        </div>
