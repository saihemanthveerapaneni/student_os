          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-3 flex flex-col gap-6 mt-4 border-t-4 border-on-surface pt-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                <Link href="/settings?section=1" className="bg-[#ffe251] text-[#1a1b22] p-4 neubrutal-border neubrutal-shadow rounded-lg hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none transition-all flex items-center justify-between group">
                ...
                <Link href="/settings?section=2" className="bg-[#b4c5ff] text-[#1a1b22] p-4 neubrutal-border neubrutal-shadow rounded-lg hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none transition-all flex items-center justify-between group">
                ...
                <Link href="/settings?section=3" className="bg-[#4ade80] text-[#1a1b22] p-4 neubrutal-border neubrutal-shadow rounded-lg hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none transition-all flex items-center justify-between group">
                ...
                <Link href="/settings?section=4" className="bg-[#ffb59d] text-[#1a1b22] p-4 neubrutal-border neubrutal-shadow rounded-lg hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none transition-all flex items-center justify-between group">
                ...
                <Link href="/settings?section=5" className="bg-[#F5F0DC] text-[#1a1b22] p-4 neubrutal-border neubrutal-shadow rounded-lg hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none transition-all flex items-center justify-between group">
                ...
                <Link href="/settings?section=6" className="bg-[#ff5c5c] text-[#1a1b22] p-4 neubrutal-border neubrutal-shadow rounded-lg hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none transition-all flex items-center justify-between group">
